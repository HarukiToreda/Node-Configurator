    ...
    <FormProvider {...methods}>
      ...
      >
        {fieldGroups.map((fieldGroup) => (
          <div key={fieldGroup.label} className="space-y-3 sm:space-y-2.5">
            <div>
              <Heading as="h4" className="font-medium text-lg">
                {fieldGroup.label}
              </Heading>
              <Subtle className="text-xs">{fieldGroup.description}</Subtle>
              <Subtle className="text-xs font-semibold">
                {fieldGroup?.notes}
              </Subtle>
            </div>
