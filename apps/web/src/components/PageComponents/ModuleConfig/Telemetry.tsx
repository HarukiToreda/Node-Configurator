      ...
      fieldGroups={[
        {
          ...
          fields: [
            ...
            {
              type: "toggle",
              name: "healthMeasurementEnabled",
              label: t("telemetry.healthMeasurementEnabled.label"),
              description: t("telemetry.healthMeasurementEnabled.description"),
            },
            {
              type: "number",
              name: "healthUpdateInterval",
              label: t("telemetry.healthUpdateInterval.label"),
              description: t("telemetry.healthUpdateInterval.description"),
              properties: { suffix: t("unit.second.plural") },
            },
            {
              type: "toggle",
              name: "healthScreenEnabled",
              label: t("telemetry.healthScreenEnabled.label"),
              description: t("telemetry.healthScreenEnabled.description"),
            },
          ],
        },
      ]}
